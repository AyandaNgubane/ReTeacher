const SOURCES = [
  ...
  },
  {
    label: "YouTube",
    detail:
      "Lectures, talks, and explainer videos found directly on YouTube via yt-dlp — no API key, no quota, just search.",
    icon: <path d="M6 10a4 4 0 0 1 4-4h20a4 4 0 0 1 4 4v12a4 4 0 0 1-4 4H10a4 4 0 0 1-4-4V10Zm11 2v8l7-4-7-4Z" />,
  },
  {
    label: "Books",
    detail:
      "Open Library, the Internet Archive's open book catalog, turns up published works on the subject — useful for depth a quick search won't give you.",
